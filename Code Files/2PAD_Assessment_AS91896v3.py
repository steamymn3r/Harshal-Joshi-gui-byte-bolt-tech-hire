...
def save_order_action():
    ...
    try:
        with open(filename, "a") as f:
            ...
            f.write(f"Date: {timestamp} | Customer: {name_entry} | Items: {items_ordered} | quantity: {quantity}\n")
...
tk.Label(new_order_menu_frame, text="Customer Name:", bg="#fff6d6").pack()
entry_name = tk.Entry(new_order_menu_frame)
entry_name.pack(pady=2)

tk.Label(new_order_menu_frame, text="Quantity Wanted:", bg="#fff6d6").pack()
